...
# Function to evaluate expressions (arithmetic operations)
def evaluate_expression(expr):
    # Check if the expression is a number (integer or float)
    if isinstance(expr, (int, float)):
        return expr
    # If the expression is a string, try to evaluate it
